...
export class GetallrefundsfororderRequest extends SpeakeasyBase {
...
export class GetallrefundsfororderResponse extends SpeakeasyBase {
    /**
     ...
     * OK
     */
    @SpeakeasyMetadata({ elemType: shared.RefundsEntity })
